...
namespace Shabasher.Core.Interfaces
{
    public interface IShabashesManageService
    {
        ...
        Task<Result<ShabashRemoveAvatarResponse>> RemoveShabashAvatarAsync(string shabashId, string userId);
        ...
        Task<Result> KickFromShabashAsync(string userId, string adminId, string shabashId);
    }
}
